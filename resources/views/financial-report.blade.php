...
<body class="newDesignLanguage" style="background-color: rgb(246, 246, 247); color: rgb(32, 34, 35);">
    <div id="app">
        <div style="--p-background:rgba(246, 246, 247, 1);--p-background-hovered:rgba(241, 242, 243, 1);--p-background-pressed:rgba(237, 238, 239, 1);--p-background-selected:rgba(237, 238, 239, 1);--p-surface:rgba(255, 255, 255, 1);--p-surface-neutral:rgba(228, 229, 231, 1);--p-surface-neutral-hovered:rgba(219, 221, 223, 1);--p-surface-neutral-pressed:rgba(201, 204, 208, 1);--p-surface-neutral-disabled:rgba(241, 242, 243, 1);--p-surface-neutral-subdued:rgba(246, 246, 247, 1);--p-surface-subdued:rgba(250, 251, 251, 1);--p-surface-disabled:rgba(250, 251, 251, 1);--p-surface-hovered:rgba(246, 246, 247, 1);--p-surface-pressed:rgba(241, 242, 243, 1);--p-surface-depressed:rgba(237, 238, 239, 1);--p-backdrop:rgba(0, 0, 0, 0.5);--p-overlay:rgba(255, 255, 255, 0.5);--p-shadow-from-dim-light:rgba(0, 0, 0, 0.2);--p-shadow-from-ambient-light:rgba(23, 24, 24, 0.05);--p-shadow-from-direct-light:rgba(0, 0, 0, 0.15);--p-hint-from-direct-light:rgba(0, 0, 0, 0.15);--p-on-surface-background:rgba(241, 242, 243, 1);--p-border:rgba(140, 145, 150, 1);--p-border-neutral-subdued:rgba(186, 191, 195, 1);--p-border-hovered:rgba(153, 158, 164, 1);--p-border-disabled:rgba(210, 213, 216, 1);--p-border-subdued:rgba(201, 204, 207, 1);--p-border-depressed:rgba(87, 89, 89, 1);--p-border-shadow:rgba(174, 180, 185, 1);--p-border-shadow-subdued:rgba(186, 191, 196, 1);--p-divider:rgba(225, 227, 229, 1);--p-icon:rgba(92, 95, 98, 1);--p-icon-hovered:rgba(26, 28, 29, 1);--p-icon-pressed:rgba(68, 71, 74, 1);--p-icon-disabled:rgba(186, 190, 195, 1);--p-icon-subdued:rgba(140, 145, 150, 1);--p-text:rgba(32, 34, 35, 1);--p-text-disabled:rgba(140, 145, 150, 1);--p-text-subdued:rgba(109, 113, 117, 1);--p-interactive:rgba(44, 110, 203, 1);--p-interactive-disabled:rgba(189, 193, 204, 1);--p-interactive-hovered:rgba(31, 81, 153, 1);--p-interactive-pressed:rgba(16, 50, 98, 1);--p-focused:rgba(69, 143, 255, 1);--p-surface-selected:rgba(242, 247, 254, 1);--p-surface-selected-hovered:rgba(237, 244, 254, 1);--p-surface-selected-pressed:rgba(229, 239, 253, 1);--p-icon-on-interactive:rgba(255, 255, 255, 1);--p-text-on-interactive:rgba(255, 255, 255, 1);--p-action-secondary:rgba(255, 255, 255, 1);--p-action-secondary-disabled:rgba(255, 255, 255, 1);--p-action-secondary-hovered:rgba(246, 246, 247, 1);--p-action-secondary-pressed:rgba(241, 242, 243, 1);--p-action-secondary-depressed:rgba(109, 113, 117, 1);--p-action-primary:rgba(0, 128, 96, 1);--p-action-primary-disabled:rgba(241, 241, 241, 1);--p-action-primary-hovered:rgba(0, 110, 82, 1);--p-action-primary-pressed:rgba(0, 94, 70, 1);--p-action-primary-depressed:rgba(0, 61, 44, 1);--p-icon-on-primary:rgba(255, 255, 255, 1);--p-text-on-primary:rgba(255, 255, 255, 1);--p-surface-primary-selected:rgba(241, 248, 245, 1);--p-surface-primary-selected-hovered:rgba(179, 208, 195, 1);--p-surface-primary-selected-pressed:rgba(162, 188, 176, 1);--p-border-critical:rgba(253, 87, 73, 1);--p-border-critical-subdued:rgba(224, 179, 178, 1);--p-border-critical-disabled:rgba(255, 167, 163, 1);--p-icon-critical:rgba(215, 44, 13, 1);--p-surface-critical:rgba(254, 211, 209, 1);--p-surface-critical-subdued:rgba(255, 244, 244, 1);--p-surface-critical-subdued-hovered:rgba(255, 240, 240, 1);--p-surface-critical-subdued-pressed:rgba(255, 233, 232, 1);--p-surface-critical-subdued-depressed:rgba(254, 188, 185, 1);--p-text-critical:rgba(215, 44, 13, 1);--p-action-critical:rgba(216, 44, 13, 1);--p-action-critical-disabled:rgba(241, 241, 241, 1);--p-action-critical-hovered:rgba(188, 34, 0, 1);--p-action-critical-pressed:rgba(162, 27, 0, 1);--p-action-critical-depressed:rgba(108, 15, 0, 1);--p-icon-on-critical:rgba(255, 255, 255, 1);--p-text-on-critical:rgba(255, 255, 255, 1);--p-interactive-critical:rgba(216, 44, 13, 1);--p-interactive-critical-disabled:rgba(253, 147, 141, 1);--p-interactive-critical-hovered:rgba(205, 41, 12, 1);--p-interactive-critical-pressed:rgba(103, 15, 3, 1);--p-border-warning:rgba(185, 137, 0, 1);--p-border-warning-subdued:rgba(225, 184, 120, 1);--p-icon-warning:rgba(185, 137, 0, 1);--p-surface-warning:rgba(255, 215, 157, 1);--p-surface-warning-subdued:rgba(255, 245, 234, 1);--p-surface-warning-subdued-hovered:rgba(255, 242, 226, 1);--p-surface-warning-subdued-pressed:rgba(255, 235, 211, 1);--p-text-warning:rgba(145, 106, 0, 1);--p-border-highlight:rgba(68, 157, 167, 1);--p-border-highlight-subdued:rgba(152, 198, 205, 1);--p-icon-highlight:rgba(0, 160, 172, 1);--p-surface-highlight:rgba(164, 232, 242, 1);--p-surface-highlight-subdued:rgba(235, 249, 252, 1);--p-surface-highlight-subdued-hovered:rgba(228, 247, 250, 1);--p-surface-highlight-subdued-pressed:rgba(213, 243, 248, 1);--p-text-highlight:rgba(52, 124, 132, 1);--p-border-success:rgba(0, 164, 124, 1);--p-border-success-subdued:rgba(149, 201, 180, 1);--p-icon-success:rgba(0, 127, 95, 1);--p-surface-success:rgba(174, 233, 209, 1);--p-surface-success-subdued:rgba(241, 248, 245, 1);--p-surface-success-subdued-hovered:rgba(236, 246, 241, 1);--p-surface-success-subdued-pressed:rgba(226, 241, 234, 1);--p-text-success:rgba(0, 128, 96, 1);--p-decorative-one-icon:rgba(126, 87, 0, 1);--p-decorative-one-surface:rgba(255, 201, 107, 1);--p-decorative-one-text:rgba(61, 40, 0, 1);--p-decorative-two-icon:rgba(175, 41, 78, 1);--p-decorative-two-surface:rgba(255, 196, 176, 1);--p-decorative-two-text:rgba(73, 11, 28, 1);--p-decorative-three-icon:rgba(0, 109, 65, 1);--p-decorative-three-surface:rgba(146, 230, 181, 1);--p-decorative-three-text:rgba(0, 47, 25, 1);--p-decorative-four-icon:rgba(0, 106, 104, 1);--p-decorative-four-surface:rgba(145, 224, 214, 1);--p-decorative-four-text:rgba(0, 45, 45, 1);--p-decorative-five-icon:rgba(174, 43, 76, 1);--p-decorative-five-surface:rgba(253, 201, 208, 1);--p-decorative-five-text:rgba(79, 14, 31, 1);--p-border-radius-base:0.4rem;--p-border-radius-wide:0.8rem;--p-border-radius-full:50%;--p-card-shadow:0px 0px 5px var(--p-shadow-from-ambient-light), 0px 1px 2px var(--p-shadow-from-direct-light);--p-popover-shadow:-1px 0px 20px var(--p-shadow-from-ambient-light), 0px 1px 5px var(--p-shadow-from-direct-light);--p-modal-shadow:0px 26px 80px var(--p-shadow-from-dim-light), 0px 0px 1px var(--p-shadow-from-dim-light);--p-top-bar-shadow:0 2px 2px -1px var(--p-shadow-from-direct-light);--p-button-drop-shadow:0 1px 0 rgba(0, 0, 0, 0.05);--p-button-inner-shadow:inset 0 -1px 0 rgba(0, 0, 0, 0.2);--p-button-pressed-inner-shadow:inset 0 1px 0 rgba(0, 0, 0, 0.15);--p-override-none:none;--p-override-transparent:transparent;--p-override-one:1;--p-override-visible:visible;--p-override-zero:0;--p-override-loading-z-index:514;--p-button-font-weight:500;--p-non-null-content:'';--p-choice-size:2rem;--p-icon-size:1rem;--p-choice-margin:0.1rem;--p-control-border-width:0.2rem;--p-banner-border-default:inset 0 0.1rem 0 0 var(--p-border-neutral-subdued), inset 0 0 0 0.1rem var(--p-border-neutral-subdued);--p-banner-border-success:inset 0 0.1rem 0 0 var(--p-border-success-subdued), inset 0 0 0 0.1rem var(--p-border-success-subdued);--p-banner-border-highlight:inset 0 0.1rem 0 0 var(--p-border-highlight-subdued), inset 0 0 0 0.1rem var(--p-border-highlight-subdued);--p-banner-border-warning:inset 0 0.1rem 0 0 var(--p-border-warning-subdued), inset 0 0 0 0.1rem var(--p-border-warning-subdued);--p-banner-border-critical:inset 0 0.1rem 0 0 var(--p-border-critical-subdued), inset 0 0 0 0.1rem var(--p-border-critical-subdued);--p-badge-mix-blend-mode:luminosity;--p-thin-border-subdued:0.1rem solid var(--p-border-subdued);--p-text-field-spinner-offset:0.2rem;--p-text-field-focus-ring-offset:-0.4rem;--p-text-field-focus-ring-border-radius:0.7rem;--p-button-group-item-spacing:-0.1rem;--p-duration-1-0-0:100ms;--p-duration-1-5-0:150ms;--p-ease-in:cubic-bezier(0.5, 0.1, 1, 1);--p-ease:cubic-bezier(0.4, 0.22, 0.28, 1);--p-range-slider-thumb-size-base:1.6rem;--p-range-slider-thumb-size-active:2.4rem;--p-range-slider-thumb-scale:1.5;--p-badge-font-weight:400;--p-frame-offset:0px">
            <div style="color:rgba(32, 34, 35, 1)">
                <div class="Polaris-Frame_2qi9y Polaris-Frame--hasNav_wlvjn Polaris-Frame--hasTopBar_1162r" data-polaris-layer="true" data-has-navigation="true">
                    <div class="Polaris-Frame__Skip_yj7bt"><a href="#AppFrameMainContent">Skip to content</a></div>
                    <div class="Polaris-Frame__TopBar_z6tf9" data-polaris-layer="true" data-polaris-top-bar="true" id="AppFrameTopBar">
                        <div class="">
                            <div style="color:rgba(32, 34, 35, 1)">
                                <div>
                                    <div class="Polaris-TopBar_z6tf9 Polaris-TopBar__TopBar--newDesignLanguage_xnbkn"><button type="button" class="Polaris-TopBar__NavigationIcon_1bdcy" aria-label="Toggle menu"><span class="Polaris-Icon_yj27d Polaris-Icon--newDesignLanguage_1rik8"><svg viewBox="0 0 20 20" class="Polaris-Icon__Svg_375hu" focusable="false" aria-hidden="true">
                                        ...
                                        <div class="Polaris-TopBar__ContextControl_3di0f">
                                            <div class="bAUvj">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="_1hq81">
                                                            <div class="_2J9vU"></div><button class="_1320u" tabindex="0" type="button">
                                                                <div class="_3gw9g">
                                                                    <div class="_1Cu44">
                                                                        <div class="_3Bh_j _9Z_oP"><svg viewBox="0 0 25 28">
                                                                                <path fill="#95BF47" fill-rule="evenodd" d="M17.836 27.059l-.062-23.736c-.16-.16-.472-.112-.594-.076l-.813.252a5.675 5.675 0 00-.39-.957c-.576-1.1-1.42-1.682-2.44-1.683h-.003c-.068 0-.136.006-.204.012h-.008a2.234 2.234 0 00-.092-.105C12.786.29 12.216.059 11.533.079c-1.318.038-2.63.99-3.693 2.679-.75 1.19-1.318 2.683-1.48 3.84L3.767 7.4c-.764.24-.788.263-.888.982C2.803 8.928.806 24.377.806 24.377l16.743 2.895.287-.213zM12.35 1.163a1.347 1.347 0 00-.792-.208c-2.033.06-3.807 3.235-4.26 5.352l1.949-.604.347-.107c.255-1.344.896-2.738 1.733-3.636a3.821 3.821 0 011.023-.797zm-1.793 4.135l2.796-.866c.009-.728-.07-1.805-.435-2.565-.388.16-.715.44-.95.691-.628.675-1.14 1.705-1.41 2.74zM14.23 4.16l1.299-.403c-.208-.674-.7-1.805-1.7-1.994.311.802.391 1.73.4 2.397z" clip-rule="evenodd"></path>
                                                                                <path fill="#5E8E3E" d="M21.587 5.088c-.099-.008-2.035-.037-2.035-.037s-1.619-1.573-1.778-1.733a.399.399 0 00-.225-.103v24.053l7.256-1.804S21.844 5.447 21.825 5.31a.263.263 0 00-.238-.222z"></path>
                                                                                <path fill="currentColor" d="M13.528 8.824l-.843 3.153s-.94-.429-2.054-.358c-1.635.103-1.652 1.134-1.636 1.392.09 1.41 3.799 1.718 4.008 5.021.163 2.599-1.379 4.376-3.601 4.516-2.667.169-4.135-1.405-4.135-1.405l.565-2.404s1.478 1.115 2.66 1.04c.773-.048 1.05-.677 1.021-1.121-.116-1.84-3.137-1.731-3.328-4.754-.16-2.544 1.51-5.12 5.196-5.353 1.42-.09 2.147.273 2.147.273"></path>
                                                                            </svg></div>
                                                                    </div>
                                                                    <div class="_1u5M3">
                                                                        <div class="_1cICO"><span class="Polaris-TextStyle--variationStrong_rpyvj">akeneo-shop</span></div>
                                                                    </div>
                                                                </div><span class="_36o6v"><span class="Polaris-Icon_yj27d Polaris-Icon--colorInk_xnlrc Polaris-Icon--isColored_uhqnf Polaris-Icon--newDesignLanguage_1rik8"><svg viewBox="0 0 20 20" class="Polaris-Icon__Svg_375hu" focusable="false" aria-hidden="true">
                                                ...
                                                <div class="dx9wK">
                                                    <div class="_2J9vU"></div>
                                                    <div class="_1qkdo"><button class="_1320u" tabindex="0" type="button">
                                                            <div class="_3gw9g">
                                                                <div class="_1Cu44">
                                                                    <div class="_3Bh_j _9Z_oP"><svg viewBox="0 0 25 28">
                                                                            <path fill="#95BF47" fill-rule="evenodd" d="M17.836 27.059l-.062-23.736c-.16-.16-.472-.112-.594-.076l-.813.252a5.675 5.675 0 00-.39-.957c-.576-1.1-1.42-1.682-2.44-1.683h-.003c-.068 0-.136.006-.204.012h-.008a2.234 2.234 0 00-.092-.105C12.786.29 12.216.059 11.533.079c-1.318.038-2.63.99-3.693 2.679-.75 1.19-1.318 2.683-1.48 3.84L3.767 7.4c-.764.24-.788.263-.888.982C2.803 8.928.806 24.377.806 24.377l16.743 2.895.287-.213zM12.35 1.163a1.347 1.347 0 00-.792-.208c-2.033.06-3.807 3.235-4.26 5.352l1.949-.604.347-.107c.255-1.344.896-2.738 1.733-3.636a3.821 3.821 0 011.023-.797zm-1.793 4.135l2.796-.866c.009-.728-.07-1.805-.435-2.565-.388.16-.715.44-.95.691-.628.675-1.14 1.705-1.41 2.74zM14.23 4.16l1.299-.403c-.208-.674-.7-1.805-1.7-1.994.311.802.391 1.73.4 2.397z" clip-rule="evenodd"></path>
                                                            ...
                                                            </div><span class="_2qs6M"><span class="Polaris-Icon_yj27d Polaris-Icon--colorWhite_bnvg7 Polaris-Icon--newDesignLanguage_1rik8"><svg viewBox="0 0 20 20" class="Polaris-Icon__Svg_375hu" focusable="false" aria-hidden="true">
                                                                        <path d="M5 8l5 5 5-5H5z"></path>
                                                                    </svg></span></span>
                                                        </button></div>
                                                    <div class="_1hq81">
                                                                    ...
                                                                    <div class="Polaris-Connected_wopc9 Polaris-Connected--newDesignLanguage_1rik8">
                                                                        <div class="Polaris-Connected__Item_yiyol Polaris-Connected__Item--primary_rmh5m">
                                                                            <div class="Polaris-TextField_1spwi Polaris-TextField--newDesignLanguage_1rik8">
                                                                                <div class="Polaris-TextField__Prefix_10fbz" id="Switcher__SearchPrefix"><span class="Polaris-Icon_yj27d Polaris-Icon--colorSkyDark_1kpf3 Polaris-Icon--isColored_uhqnf Polaris-Icon--newDesignLanguage_1rik8"><svg viewBox="0 0 20 20" class="Polaris-Icon__Svg_375hu" focusable="false" aria-hidden="true">
                                                                                        ...
                                                                                        </svg></span></div><input id="Switcher__Search" placeholder="Search" autocomplete="off" class="Polaris-TextField__Input_30ock" type="text" aria-labelledby="Switcher__SearchLabel Switcher__SearchPrefix" aria-invalid="false" aria-autocomplete="none" aria-multiline="false" value="">
                    ...
                    <div>
                        <div class="Polaris-Frame__Navigation_1ajsq Polaris-Frame__Navigation--newDesignLanguage_68mzh" id="AppFrameNav">

                            <nav class="Polaris-Navigation_1ajsq Polaris-Navigation__Navigation--newDesignLanguage_68mzh">
                                <div class="Polaris-Navigation__ContextControl_3di0f">
                                    <div class="bAUvj">
                                        <div class="_2LkRk">
                                            <div>
                                                <div class="_2J9vU"></div>
                                                <div class="_1qkdo"><button class="_1320u" tabindex="0" type="button" aria-controls="Polarispopover26" aria-owns="Polarispopover26" aria-expanded="false">
                                                        <div class="_3gw9g">
                                                            <div class="_1Cu44">
                                                                <div class="_3Bh_j _9Z_oP"><svg viewBox="0 0 25 28">
                                                                        <path fill="#95BF47" fill-rule="evenodd" d="M17.836 27.059l-.062-23.736c-.16-.16-.472-.112-.594-.076l-.813.252a5.675 5.675 0 00-.39-.957c-.576-1.1-1.42-1.682-2.44-1.683h-.003c-.068 0-.136.006-.204.012h-.008a2.234 2.234 0 00-.092-.105C12.786.29 12.216.059 11.533.079c-1.318.038-2.63.99-3.693 2.679-.75 1.19-1.318 2.683-1.48 3.84L3.767 7.4c-.764.24-.788.263-.888.982C2.803 8.928.806 24.377.806 24.377l16.743 2.895.287-.213zM12.35 1.163a1.347 1.347 0 00-.792-.208c-2.033.06-3.807 3.235-4.26 5.352l1.949-.604.347-.107c.255-1.344.896-2.738 1.733-3.636a3.821 3.821 0 011.023-.797zm-1.793 4.135l2.796-.866c.009-.728-.07-1.805-.435-2.565-.388.16-.715.44-.95.691-.628.675-1.14 1.705-1.41 2.74zM14.23 4.16l1.299-.403c-.208-.674-.7-1.805-1.7-1.994.311.802.391 1.73.4 2.397z" clip-rule="evenodd"></path>
                                        ...
                                        <li class="Polaris-Navigation__ListItem_wxd2m">
                                            <div class="Polaris-Navigation__ItemWrapper_1kbav"><a data-polaris-unstyled="true" class="Polaris-Navigation__Item_yiyol" tabindex="0" aria-disabled="false" href="/net-capital-report">
                                                    <div class="Polaris-Navigation__Icon_yj27d"><span class="Polaris-Icon_yj27d Polaris-Icon--newDesignLanguage_1rik8"><svg viewBox="0 0 20 20" class="Polaris-Icon__Svg_375hu" focusable="false" aria-hidden="true">
                                                            ...
                                                            </svg></span></div><span class="Polaris-Navigation__Text_yj3uv">Net Capital Balance</span>
                            ...
                            <button type="button" class="Polaris-Frame__NavigationDismiss_s8t2w" aria-hidden="true" aria-label="Close navigation" tabindex="-1"><span class="Polaris-Icon_yj27d Polaris-Icon--newDesignLanguage_1rik8"><svg viewBox="0 0 20 20" class="Polaris-Icon__Svg_375hu" focusable="false" aria-hidden="true">
                                                    ...
                                                    <div class="Polaris-Card__Section_1b1h1">
                                                        <div class="Polaris-FormLayout_1wntl">
                                                            <div class="Polaris-FormLayout__Item_yiyol">
                                                                <div class="">
                                                                    <div class="Polaris-Labelled__LabelWrapper_bf6ys">
                                                                        <div class="Polaris-Label_2vd36"><label id="collectionTitleTextFieldLabel" for="collectionTitleTextField" class="Polaris-Label__Text_yj3uv">Year</label></div>
                                                                    </div>
                                                                    <div class="Polaris-Connected_wopc9 Polaris-Connected--newDesignLanguage_1rik8">
                                                                        <div class="Polaris-Connected__Item_yiyol Polaris-Connected__Item--primary_rmh5m">
                                                                            <div class="Polaris-TextField_1spwi Polaris-TextField--newDesignLanguage_1rik8"><input name="year" required="" id="collectionTitleTextField" placeholder="e.g.2019" class="Polaris-TextField__Input_30ock" aria-labelledby="collectionTitleTextFieldLabel" aria-invalid="false" aria-multiline="false" value="">
                                                                                <div class="Polaris-TextField__Backdrop_1x2i2"></div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="Polaris-FormLayout__Item_yiyol">
                                                                <div class="">
                                                                    <div class="Polaris-Labelled__LabelWrapper_bf6ys">
                                                                        <div class="Polaris-Label_2vd36"><label id="collectionTitleTextFieldLabel" for="collectionTitleTextField" class="Polaris-Label__Text_yj3uv">Name</label></div>
                                                                    </div>
                                                                    <div class="Polaris-Connected_wopc9 Polaris-Connected--newDesignLanguage_1rik8">
                                                                        <div class="Polaris-Connected__Item_yiyol Polaris-Connected__Item--primary_rmh5m">
                                                                            <div class="Polaris-TextField_1spwi Polaris-TextField--newDesignLanguage_1rik8"><input name="name" id="collectionTitleTextField" required="" placeholder="e.g. Financial Statement - June 2019" class="Polaris-TextField__Input_30ock" aria-labelledby="collectionTitleTextFieldLabel" aria-invalid="false" aria-multiline="false" value="">
                                                                                <div class="Polaris-TextField__Backdrop_1x2i2"></div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <div class="Polaris-Card_yis1o Polaris-Card--newDesignLanguage_1rik8">
                                                   <!--
                                                    <div class="Polaris-Card__Header_z4uwg">
                                                        <h2 class="Polaris-Heading_1brcv">Category type</h2>
                                                    </div>
                                                    ...
                                                    <div class="Polaris-Card__Section_1b1h1">
                                                        <div class="Polaris-Card__SectionHeader_1aytf">
                                                            <h3 aria-label="Conditions" class="Polaris-Subheading_syouu">Conditions</h3>
                                                        </div>
                                                                ...
                                                                <div class="Polaris-Stack__Item_yiyol">
                                                                    <div class="Polaris-Stack_32wu2 Polaris-Stack--alignmentCenter_1rtaw">
                                                                        ...
                                                                        <div class="Polaris-Stack__Item_yiyol">
                                                                            <div>
                                                                                <div class="Polaris-Stack_32wu2 Polaris-Stack--alignmentCenter_1rtaw">
                                                                                    <div class="Polaris-Stack__Item_yiyol"><label class="Polaris-Choice_j5gzq" for="all"><span class="Polaris-Choice__Control_1u8vs"><span class="Polaris-RadioButton_bsatr Polaris-RadioButton--newDesignLanguage_1rik8"><input id="all" name="conditionMatch" type="radio" class="Polaris-RadioButton__Input_30ock" value="" checked=""><span class="Polaris-RadioButton__Backdrop_1x2i2"></span></span></span><span class="Polaris-Choice__Label_2vd36">all conditions</span></label></div>
                                                                                    <div class="Polaris-Stack__Item_yiyol"><label class="Polaris-Choice_j5gzq" for="any"><span class="Polaris-Choice__Control_1u8vs"><span class="Polaris-RadioButton_bsatr Polaris-RadioButton--newDesignLanguage_1rik8"><input id="any" name="conditionMatch" type="radio" class="Polaris-RadioButton__Input_30ock" value=""><span class="Polaris-RadioButton__Backdrop_1x2i2"></span></span></span><span class="Polaris-Choice__Label_2vd36">any condition</span></label></div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                                    ...
                                                                                    <div class="KDsCD">
                                                                                        <div>
                                                                                            <div class="Polaris-Labelled--hidden_riqie">
                                                                                                ...
                                                                                                <div class="Polaris-Select_ss8pm Polaris-Select--newDesignLanguage_1rik8"><select id="PolarisSelect4" class="Polaris-Select__Input_30ock" aria-invalid="false">
                                                                                                        ...
                                                                                                        <option value="IS_PRICE_REDUCED" hidden="">Compare at price</option>
                                                                                                    </select>
                                                                                                    <div class="Polaris-Select__Content_xd1mk" aria-hidden="true" aria-disabled="false"><span class="Polaris-Select__SelectedOption_azu52">Product tag</span><span class="Polaris-Select__Icon_yj27d"><span class="Polaris-Icon_yj27d Polaris-Icon--newDesignLanguage_1rik8"><svg viewBox="0 0 20 20" class="Polaris-Icon__Svg_375hu" focusable="false" aria-hidden="true">
                                                                                        ...
                                                                                        <div class="Polaris-Labelled--hidden_riqie">
                                                                                            <div class="Polaris-Labelled__LabelWrapper_bf6ys">
                                                                                                <div class="Polaris-Label_2vd36"><label id="PolarisSelect5Label" for="PolarisSelect5" class="Polaris-Label__Text_yj3uv">Condition 1 operation</label></div>
                                                                                            </div>
                                                                                            <div class="Polaris-Select_ss8pm Polaris-Select--newDesignLanguage_1rik8"><select id="PolarisSelect5" class="Polaris-Select__Input_30ock" aria-invalid="true">
                                                                                                    <option value="EQUALS">is equal to</option>
                                                                                                    <option value="NOT_EQUALS" disabled="false">is not equal to</option>
                                                                                                    ...
                                                                                                    <option value="IS_SET">Yes</option>
                                                                                                    <option value="IS_NOT_SET">No</option>
                                                                                                </select>
                                                                                                <div class="Polaris-Select__Content_xd1mk" aria-hidden="true" aria-disabled="false"><span class="Polaris-Select__SelectedOption_azu52">is equal to</span><span class="Polaris-Select__Icon_yj27d"><span class="Polaris-Icon_yj27d Polaris-Icon--newDesignLanguage_1rik8"><svg viewBox="0 0 20 20" class="Polaris-Icon__Svg_375hu" focusable="false" aria-hidden="true">
                                                                                                                <path d="M10 16l-4-4h8l-4 4zm0-12l4 4H6l4-4z"></path>
                                                                                                            </svg></span></span></div>
                                                                                                <div class="Polaris-Select__Backdrop_1x2i2"></div>
                                                                                            </div>
                                                                                        ...
                                                                                        <div>
                                                                                            <div>
                                                                                                <div class="Polaris-Labelled--hidden_riqie">
                                                                                                    <div class="Polaris-Labelled__LabelWrapper_bf6ys">
                                                                                                        <div class="Polaris-Label_2vd36"><label id="0-ConditionFieldLabel" for="0-ConditionField" class="Polaris-Label__Text_yj3uv">Condition 1 value</label></div>
                                                                                                    </div>
                                                                                                    <div class="Polaris-Connected_wopc9 Polaris-Connected--newDesignLanguage_1rik8">
                                                                                                        <div class="Polaris-Connected__Item_yiyol Polaris-Connected__Item--primary_rmh5m">
                                                                                                            <div class="Polaris-TextField_1spwi Polaris-TextField--newDesignLanguage_1rik8"><input id="0-ConditionField" placeholder="" autocomplete="off" class="Polaris-TextField__Input_30ock" aria-labelledby="0-ConditionFieldLabel" aria-invalid="false" aria-multiline="false" value="" aria-autocomplete="list" role="combobox" autocapitalize="off" aria-expanded="false" aria-controls="Polarispopover78" tabindex="0" aria-owns="Polarispopover78">
                                                                                                                <div class="Polaris-TextField__Backdrop_1x2i2"></div>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div class="Polaris-Connected__Item_yiyol Polaris-Connected__Item--connection_o17m7"><span><button class="Polaris-Button_r99lw Polaris-Button--newDesignLanguage_1rik8 Polaris-Button--iconOnly_viazp" aria-label="Show options" type="button" aria-controls="0-ConditionField" aria-expanded="false"><span class="Polaris-Button__Content_xd1mk"><span class="Polaris-Button__Icon_yj27d"><span class="Polaris-Icon_yj27d Polaris-Icon--newDesignLanguage_1rik8"><svg viewBox="0 0 20 20" class="Polaris-Icon__Svg_375hu" focusable="false" aria-hidden="true">
                                                                                                                                    <path d="M10 16l-4-4h8l-4 4zm0-12l4 4H6l4-4z"></path>
                                                    ...
                                                    <div class="Polaris-Card__Section_1b1h1">
                                                        <div class="Polaris-FormLayout_1wntl">
                                                            <div class="Polaris-FormLayout__Item_yiyol">
                                                                <div class="">
                                                                    <div class="Polaris-Labelled__LabelWrapper_bf6ys">
                                                                        <div class="Polaris-Label_2vd36"><label id="PolarisTextField18Label" for="PolarisTextField18" class="Polaris-Label__Text_yj3uv">Page title</label></div>
                                                                    </div>
                                                                    <div class="Polaris-Connected_wopc9 Polaris-Connected--newDesignLanguage_1rik8">
                                                                        <div class="Polaris-Connected__Item_yiyol Polaris-Connected__Item--primary_rmh5m">
                                                                    ...
                                                                    <div class="Polaris-Labelled__HelpText_8qj1a" id="PolarisTextField18HelpText">0 of 70 characters used</div>
                                                                </div>
                                                            </div>
                                                            <div class="Polaris-FormLayout__Item_yiyol">
                                                                <div class="">
                                                                    <div class="Polaris-Labelled__LabelWrapper_bf6ys">
                                                                        <div class="Polaris-Label_2vd36"><label id="PolarisTextField19Label" for="PolarisTextField19" class="Polaris-Label__Text_yj3uv">Description</label></div>
                                                                    </div>
                                                                    <div class="Polaris-Connected_wopc9 Polaris-Connected--newDesignLanguage_1rik8">
                                                                        <div class="Polaris-Connected__Item_yiyol Polaris-Connected__Item--primary_rmh5m">
                                                                    ...
                                                                    <div class="Polaris-Labelled__HelpText_8qj1a" id="PolarisTextField19HelpText">0 of 320 characters used</div>
                                                                </div>
                                                            </div>
                                                            <div class="Polaris-FormLayout__Item_yiyol">
                                                                <div class="">
                                                                    <div class="Polaris-Labelled__LabelWrapper_bf6ys">
                                                                        <div class="Polaris-Label_2vd36"><label id="PolarisTextField20Label" for="PolarisTextField20" class="Polaris-Label__Text_yj3uv">URL and handle</label></div>
                                                                    </div>
                                                                    <div class="Polaris-Connected_wopc9 Polaris-Connected--newDesignLanguage_1rik8">
                                                                        <div class="Polaris-Connected__Item_yiyol Polaris-Connected__Item--primary_rmh5m">
                                                                            <div class="Polaris-TextField_1spwi Polaris-TextField--newDesignLanguage_1rik8">
...
<!--
                                                <div class="Polaris-Card_yis1o Polaris-Card--newDesignLanguage_1rik8">
                                                    <div class="_1SR2Q">
                                                        <div class="Polaris-Stack_32wu2">
                                                            <div class="Polaris-Stack__Item_yiyol Polaris-Stack__Item--fill_vpuzt">
                                                                <h2 class="Polaris-Heading_1brcv">Category availability</h2>
                                                            </div>
                                                            <div class="Polaris-Stack__Item_yiyol"><button class="Polaris-Button_r99lw Polaris-Button--newDesignLanguage_1rik8 Polaris-Button--plain_2z97r" type="button" onclick="call_manage()"><span class="Polaris-Button__Content_xd1mk"><span class="Polaris-Button__Text_yj3uv">Manage</span></span></button></div>

                                                        </div>
                                                        <p><span class="Polaris-TextStyle--variationSubdued_1segu">Available on 5 of 5 channels and apps</span></p>
                                                    </div>
                                                    <div class="Polaris-Card__Section_1b1h1">
                                                        <div class="Polaris-Stack_32wu2 Polaris-Stack--alignmentCenter_1rtaw">
                                                            <div class="Polaris-Stack__Item_yiyol Polaris-Stack__Item--fill_vpuzt">Online Store</div>
                                                            <div class="Polaris-Stack__Item_yiyol">
                                                                <div class="_2-G7t"><span><button class="Polaris-Button_r99lw Polaris-Button--newDesignLanguage_1rik8 Polaris-Button--plain_2z97r Polaris-Button--iconOnly_viazp" type="button" tabindex="0" aria-describedby="PolarisTooltipContent83"><span class="Polaris-Button__Content_xd1mk"><span class="Polaris-Button__Icon_yj27d"><span class="Polaris-Icon_yj27d Polaris-Icon--newDesignLanguage_1rik8"><svg viewBox="0 0 20 20" class="Polaris-Icon__Svg_375hu" focusable="false" aria-hidden="true">
                                                                                            <path fill-rule="evenodd" d="M16.5 4A1.5 1.5 0 0 1 18 5.5v11a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 2 16.5v-11A1.5 1.5 0 0 1 3.5 4H5V3a1 1 0 1 1 2 0v1h6V3a1 1 0 1 1 2 0v1h1.5zM4 8h12v8H4V8z"></path>
                                                                                        </svg></span></span></span></button></span></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="Polaris-Card__Section_1b1h1">
                                                        <div class="Polaris-Stack_32wu2 Polaris-Stack--alignmentCenter_1rtaw">
                                                            <div class="Polaris-Stack__Item_yiyol Polaris-Stack__Item--fill_vpuzt">Akeneo</div>
                                                            <div class="Polaris-Stack__Item_yiyol">
                                                                <div class="_2-G7t"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="Polaris-Card__Section_1b1h1">
                                                        <div class="Polaris-Stack_32wu2 Polaris-Stack--alignmentCenter_1rtaw">
                                                            <div class="Polaris-Stack__Item_yiyol Polaris-Stack__Item--fill_vpuzt">Point of Sale</div>
                                                            <div class="Polaris-Stack__Item_yiyol">
                                                                <div class="_2-G7t"></div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="Polaris-Card__Section_1b1h1">
                                                        <div class="Polaris-Stack_32wu2 Polaris-Stack--alignmentCenter_1rtaw">
                                                            <div class="Polaris-Stack__Item_yiyol Polaris-Stack__Item--fill_vpuzt">app_graphql</div>
                                                            <div class="Polaris-Stack__Item_yiyol">
                                                                <div class="_2-G7t"></div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="Polaris-Card__Section_1b1h1">
                                                        <div class="Polaris-Stack_32wu2 Polaris-Stack--alignmentCenter_1rtaw">
                                                            <div class="Polaris-Stack__Item_yiyol Polaris-Stack__Item--fill_vpuzt">graphql_permission</div>
                                                            <div class="Polaris-Stack__Item_yiyol">
                                                                <div class="_2-G7t"></div>
                                                            </div>
                                                        </div>
                                                                    ...
                                                                    <div class="_2aa8P">
                                                                        <div class="Polaris-DropZone-FileUpload_1fbjx Polaris-DropZone-FileUpload--newDesignLanguage_1rik8">
                                                                            <div class="Polaris-Stack_32wu2 Polaris-Stack--vertical_uiuuj Polaris-Stack--spacingTight_1o4d6">
                                                                                ...
                                                                                <div class="Polaris-Stack__Item_yiyol">
                                                                                    <div style="margin-left:45px;"><input type="file" name="report"></div>
                                                                                </div>
                                                                                <div class="Polaris-Stack__Item_yiyol">
                                            ...
                                            <div class="Polaris-Layout__Section_1b1h1">
                                                <div class="Polaris-PageActions_fcnua">
                                                    <div class="Polaris-Stack_32wu2 Polaris-Stack--spacingTight_1o4d6 Polaris-Stack--distributionTrailing_z5d5z">
                                                        <div class="Polaris-Stack__Item_yiyol"><button class="Polaris-Button_r99lw Polaris-Button--newDesignLanguage_1rik8 Polaris-Button--primary_7k9zs" type="submit"><span class="Polaris-Button__Content_xd1mk"><span class="Polaris-Button__Text_yj3uv">Upload</span></span></button></div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <li class="Polaris-ActionList__Section_1b1h1">
                                    <div class="Polaris-ActionList__Section--withoutTitle_1vpsz">
                                        <ul class="Polaris-ActionList__Actions_17m67 Polaris-ActionList--newDesignLanguage_1rik8">
                                            ...
                                            <li><a href="/logout" style="text-decoration: none;color:#E3E5E7;"><button type="button" class="Polaris-ActionList__Item_yiyol Polaris-ActionList--newDesignLanguage_1rik8">
                                                    <div class="Polaris-ActionList__Content_xd1mk">
                                                        <div class="Polaris-ActionList__Prefix_10fbz Polaris-ActionList--newDesignLanguage_1rik8"><span class="Polaris-Icon_yj27d Polaris-Icon--newDesignLanguage_1rik8"><svg viewBox="0 0 20 20" class="Polaris-Icon__Svg_375hu" focusable="false" aria-hidden="true">
                                                        ...
                                                        <div class="Polaris-ActionList__Text_yj3uv">Log out</div>
                                                    </div>
                                                </button></a></li>
